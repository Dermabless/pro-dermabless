              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                    ...
                    <h5>{{trans('file.Product details')}} *</h5>
                  </a>
                </li>
                <li class="nav-item">
                      ...
                      <form id="product-form">
                        ...
                        <div class="row">
                                ...
                                @if($lims_product_data->type == 'combo')
                                    ...
                                    @foreach($product_list as $key=>$id)
                                      <tr>
                                        ...
                                        <td>
                                          <button type="button" class="ibtnDel btn btn-danger btn-sm">X</button>
                                        </td>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <table class="table table-hover">
                                ...
                                <tr>
                                  <th>
                                    <button type="button" class="btn btn-sm"><i class="fa fa-list"></i></button>
                                  </th>
                                  <th>Image</th>
                                  <th>Remove</th>
                                </tr>
                          ...
                          <div class="col-md-12 mt-2">
                            @if($lims_product_data->is_active)
                              <h5><input name="is_active" type="checkbox" value="1" checked>&nbsp; {{trans('file.This product is active and visible for make purchase, sales')}}</h5>
                            @else
                              <h5><input name="is_active" type="checkbox" value="1">&nbsp; {{trans('file.This product is active and visible for make purchase, sales')}}</h5>
                            @endif
                          </div>
                              ...
                              <table id="variant-table" class="table table-hover variant-list">
                                ...
                                @foreach($lims_product_variant_data as $key=> $variant)
                                  <tr>
                                    ...
                                    <td>
                                      <button type="button" class="vbtnDel btn btn-sm btn-danger">X</button>
                                    </td>
                                  </tr>
                                @endforeach
                                </tbody>
                    ...
                    <table id="product-data-table" class="table table-hover">
                      ...
                      @foreach($products_locations as $product)
                        ...
                        <tr>
                          ...
                          <td>
                            {{$product->location?$product->location->warehouse->name:''}}
                          </td>
                          <td>
                            @if($product->product_purchase_id)
                              <a href="{{url('purchases/'.$product->productPurchase->purchase->id.'/edit')}}">{{$product->productPurchase->purchase->reference_no}}</a>
                            @elseif($product->product_transfer_id)
