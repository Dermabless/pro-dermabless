                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="paper_size" required id="paper-size">
                                            ...
                                            <option value="25.4">25.4 mm (0.50 inch)</option>
...
<script type="text/javascript">
    ...
    $("#submit-button").on("click", function(event) {
        ...
        if(paper_size != "0") {
            ...
            var htmltext = '<table class="barcodelist" style="width:378px; margin-top: 50px;" cellpadding="5px" cellspacing="10px">';
            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    ...
                    if($('input[name="name"]').is(":checked"))
                        htmltext += '<div style="font-size:13px; font-family: open-sans-serif,serif;">'+product_name[index] + '</div>';

                    if(paper_size == 18)
                        htmltext += '<img style="max-width:150px;" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
                    else if(paper_size ==  25.4)
                        htmltext += '<img style="max-width:100px;" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
                    else
                        htmltext += '<img style="max-width:150px;" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';

                    htmltext += '<div style="font-size:13px; font-family: open-sans-serif,serif;">'+code[index] +'</div>';
