...
<html dir="@if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl){{'rtl'}}@endif">
  <head>
    ...
    <link rel="preload" href="{{asset('vendor/datatable/fixedheader/fixedHeader.bootstrap.min.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="{{asset('vendor/datatable/fixedheader/fixedHeader.bootstrap.min.css')}}" rel="stylesheet"></noscript>
    <link rel="preload" href="{{asset('vendor/datatable/responsive/responsive.bootstrap.min.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="{{asset('vendor/datatable/responsive/responsive.bootstrap.min.css')}}" rel="stylesheet"></noscript>
    @endif
  ...
  <body @if($theme == 'dark') class="dark-mode dripicons-brightness-low" @else class="" @endif onload="myFunction()">
    <div id="loader"></div>
      <!-- Side Navbar -->
      <nav class="side-navbar" style="padding-left: 0px">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    <li id="location-menu"><a href="{{route('location.index')}}">{{trans('file.Location')}}</a></li>
                    @endif
...
{{--                    @endif--}}
          ...
          <div class="container-fluid">
            @if ($errors->any())
              <div class="alert alert-danger alert-dismissible" role="alert">
                ...
                <p>{{__('An error has occurred please check the following details...')}}</p>
                <hr>
            ...
            @if(session()->has('message'))
              <div class="alert alert-success alert-dismissible text-center">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>{{ session()->get('message') }}</div>
            @endif
    ...
    <script type="text/javascript" src="{{asset('vendor/datatable/fixedheader/dataTables.fixedHeader.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('vendor/datatable/responsive/dataTables.responsive.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('vendor/datatable/responsive/responsive.bootstrap.min.js')}}"></script>
