          ...
          <div class="row">
            ...
            <div class="col-md-7 mt-4">
              <div class="card line-chart-example">
                ...
                <div class="card-body">
                  <canvas id="cashFlow" data-color = "{{$color}}" data-color_rgba = "{{$color_rgba}}" data-recieved = "{{json_encode($payment_recieved)}}" data-sent = "{{json_encode($payment_sent)}}" data-month = "{{json_encode($month)}}" data-label1="{{trans('file.Payment Received')}}" data-label2="{{trans('file.Payment Sent')}}"></canvas>
                </div>
              </div>
            </div>
            @endif
                ...
                <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$key + 1}}</td>
                          <td>{{$sale->product_name}}<br>[{{$sale->product_code}}]</td>
                          <td>{{$sale->sold_qty}}</td>
                        </tr>
                        @endforeach
                      </tbody>
