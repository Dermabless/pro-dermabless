...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('warehouse/{id}/detail', 'WarehouseController@detail')->name('warehouse.detail');
	Route::resource('warehouse', 'WarehouseController');

	Route::post('importlocation', 'LocationController@importLocation')->name('location.import');
	Route::post('location/deletebyselection', 'LocationController@deleteBySelection');
	Route::get('location/lims_location_search', 'LocationController@limsWarehouseSearch')->name('location.search');
	...
	Route::post('sales/assignLocations', 'SaleController@assignLocations');
	Route::post('sales/productInWarehouse', 'SaleController@productInWarehouse');
    ...
    Route::post('purchases/assignLocations', 'PurchaseController@assignLocations');
	...
	Route::post('transfers/assignLocationsReceive', 'TransferController@assignLocationsReceive');
	Route::post('transfers/assignLocationsSend', 'TransferController@assignLocationsSend');
	Route::post('transfers/productInWarehouseSend', 'TransferController@productInWarehouseSend');
	...
	Route::get('setting/download', 'SettingController@download')->name('setting.download');
